...
newtype CreateWebhook = CreateWebhook'
  { _cwProjectName :: Text
...
--
-- * 'cwProjectName' - The name of the build project.
createWebhook
    :: Text -- ^ 'cwProjectName'
    -> CreateWebhook
createWebhook pProjectName_ = CreateWebhook' {_cwProjectName = pProjectName_}
...
instance ToJSON CreateWebhook where
        toJSON CreateWebhook'{..}
          = object
              (catMaybes [Just ("projectName" .= _cwProjectName)])
